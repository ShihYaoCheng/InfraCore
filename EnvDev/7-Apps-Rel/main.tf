...
module "Apps-Rel" {
  ...
  ArgoCD_TableHelmValueFiles       = "{values-v2.11.0.yaml\\, EnableIngressReliability.yaml}"
  ArgoCD_UserHelmValueFiles        = "{values-v2.11.0.yaml\\, SetServerName-Release.yaml\\, EnableIngressReliability.yaml\\, ConnectRelDB.yaml}"
