...
module "GKE-SafeCluster" {
  ...
  # When true, the cluster's private endpoint is used as the cluster endpoint and access 
  # through the public endpoint is disabled. When false, either endpoint can be used. 
...
# https://github.com/terraform-google-modules/terraform-google-kubernetes-engine/tree/v22.1.0/modules/beta-private-cluster
