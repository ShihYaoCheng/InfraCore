...
# https://registry.terraform.io/providers/hashicorp/google/latest/docs/data-sources/compute_network_endpoint_group
data "google_compute_network_endpoint_group" "NEGBattle-London" {
  name = jsondecode(data.kubernetes_service.BattleLondon.metadata[0].annotations["cloud.google.com/neg-status"])["network_endpoint_groups"]["80"]
  zone = var.ZoneLondon
}
...
data "google_compute_network_endpoint_group" "NEGBattle-LosAngeles" {
  name = jsondecode(data.kubernetes_service.BattleLosAngeles.metadata[0].annotations["cloud.google.com/neg-status"])["network_endpoint_groups"]["80"]
